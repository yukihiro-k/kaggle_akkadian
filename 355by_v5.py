...
Ensemble MBR inference — v5 HOST-CONFIRMED

Changes from 355by_v3.py (based on host-confirmed high-scoring code):
  1. Parentheses () PRESERVED (host confirmed they appear in test set)
  2. Diverse beam disabled (simpler pool = better MBR signal)
  3. Dual-pass disabled (single LP=1.3 only = less noise)
  All v3 features retained: N-model, badness scoring, final polish, bug fixes
"""
