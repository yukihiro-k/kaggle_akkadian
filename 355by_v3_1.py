...
Ensemble MBR inference — v3.1 SCORE-OPTIMISED

Changes from v3:
  1. FIX: Parentheses () preserved (were incorrectly removed)
  2. NEW: geomean MBR preset optimised for competition metric
         (geometric mean of BLEU + chrF++)
  3. TUNE: Less aggressive postprocessing to protect BLEU precision
"""
