...
Ensemble MBR inference — DUAL T4 OPTIMIZED v2

Changes from 355by.py:
  - Fix 1: Enabled use_diverse_beam for richer candidate pools
  - Fix 2: Added () to _FORBIDDEN_TRANS (matches reference pipelines)
  - Fix 3: Fixed wrapper_a unload/delete logic for dual/single GPU paths
  - Fix 4: Fixed syntax on final print statement
