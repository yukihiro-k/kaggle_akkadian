...
Ensemble MBR inference — v3.3 SPEED-OPTIMISED

All v3.2 quality improvements + speed fixes for 9h Kaggle limit:
  1. MBR pairwise uses chrF++ only (drop BLEU from O(n²) loop)
  2. Pool cap 48→30 (2.6× MBR speedup)
  3. Beam params reverted to v3 proven values (4/8)
  4. All v3.2 quality wins preserved: PN repair, postprocessing, pre-filter
"""
